...
const BlackList = LoadableComponent(()=>import('../../routes/BlackList/index'))
// 组织管理
const GroupList = LoadableComponent(()=>import('../../routes/GroupList/index'))
// 任务管理
const TaskList = LoadableComponent(()=>import('../../routes/TaskList/index'))
    ...
    return (
      <div style={{padding: 16, position: 'relative'}}>
        <Switch>
          ...
          <PrivateRoute exact path='/home/user/blacklist' component={BlackList}/>
          <PrivateRoute exact path='/home/group/list' component={GroupList}/>
          <PrivateRoute exact path='/home/task/list' component={TaskList}/>
